						...
						<div class="form-group">
							...
							<div class="col-md-8">
								...
								<div class="text-right">
									...
									<sf:hidden path="supplierId" />
									<sf:hidden path="active" />
									<button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal">Add New Supplier</button>
...
<div id="myModal" class="modal fade" role="dialog">
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<sf:form id="supplierForm" class="form-horizontal"
						modelAttribute="supplier" action="${contextRoot}/manage/supplier"
						method="POST">
